...
\begin{figure}[H]
    ...
    \caption{Tabella UML delle classi relative al \textit{Model}}
    \label{fig:uml_table_model}
\end{figure}

\subsection{Gestione dell’accesso ai dati (DAO)}
...
\begin{figure}[H]
    ...
    \caption{Tabella UML delle classi relative al \textit{Controller}}
...
\begin{figure}[H]
    ...
    \caption{Tabella UML delle classi relative a \textit{Utility ed Exception}}
